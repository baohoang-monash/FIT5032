...
using Week2_MydatabaseFirst.Models;

namespace Week2_MydatabaseFirst.Controllers
{
    public class StudentsController : Controller
    {
        private Week2_MyDatabaseFirstEntities db = new Week2_MyDatabaseFirstEntities();
